...
if(isset($_GET['a']))
{
    ...
    $up=  mysqli_query($con,"update user_reg set status='1' where user_em='$a'");
}
if(isset($_GET['b']))
{
    $b=$_GET['b'];
    ...
    $up=  mysqli_query($con,"update user_reg set status='2' where user_em='$b'");
}
?>
	...
	<div class="vc_col-sm-12 wpb_column vc_column_container">
		<div class="wpb_wrapper">
			<div class="projects_holder_outer v3 portfolio_with_space portfolio_standard "><div class="filter_outer"><div class="filter_holder">
                            <ul>
                            <li class="filter active current" data-filter="all"><span></span></li><li class="filter" data-filter="portfolio_category_17"><span></span></li><li class="filter" data-filter="portfolio_category_2"></li><li class="filter" data-filter="portfolio_category_5"></li></ul></div></div><div class="projects_holder clearfix v3 standard">
 <?php
                $sel8=  mysqli_query($con,"select * from add_product where st='0' limit 8");
                if(mysqli_num_rows($sel8)>0)
                {
                    while ($r3=  mysqli_fetch_row($sel8))
                    {
                       ?>
                                <article class="mix portfolio_category_17 portfolio_category_5  mix_all" style="display: inline-block; opacity: 1;"><div class="image_holder"><a class="portfolio_link_for_touch" href="../product/<?php echo $r3[2] ?>" target="_self"><span class="image"><img style="height: 270px;width: 100%" src="../product/<?php echo $r3[2] ?>" class="attachment-full wp-post-image" alt="qode interactive strata"></span></a><span class="text_holder"><span class="text_outer"><span class="text_inner"><span class="feature_holder"><span class="feature_holder_icons"><a class="lightbox qbutton small white" title="Stockholm Fashion" href="../product/<?php echo $r3[2] ?>" data-rel="prettyPhoto[pretty_photo_gallery]" rel="prettyPhoto[pretty_photo_gallery]">zoom</a><a class="preview qbutton small white" href="http://demo.qodeinteractive.com/bridge/portfolio_page/stockholm-fashion-destination/" target="_self">view</a></span></span></span></span></span></div><div class="portfolio_description "><h5 class="portfolio_title"><a href="http://demo.qodeinteractive.com/bridge/portfolio_page/stockholm-fashion-destination/" target="_self"><p><?php echo $r3[1];?></p></a></h5><span class="project_category">Rs/- <?php echo $r3[3] ?>&nbsp; &nbsp;<s>Rs/-<?php echo $r3[4] ?></s></span><br/><?php echo $r3[8];?></div></article>
  <?php
                    }
                }
                ?>
