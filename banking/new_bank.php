			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
                                            ...
                                            <li><a href="services.php" class="scroll">services</a></li>    
                                            <li><a href="gal.php" class="scroll">Gallery</a></li>    
						<li><a href="icons.html" data-toggle="dropdown">Account<span class="caret"></span></a>
							<ul class="dropdown-menu">
                                                            <li><a href="new_bank.php">Add Account</a></li>
                                                            <li><a href="dep_bank.php">Cash Deposit</a></li>
							</ul>
						</li>	
	...
	<div class="w3ls-section contact">
		<div class="container"> 
			<div class="w3ls-title">
				<h2 class="h3-w3l">Add Account</h2> 
			</div>  
